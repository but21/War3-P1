...
-- 三选一次数
jass.udg_SelectOneCount[1] = 99
jass.udg_SelectOneCount[2] = 99
-- 黑市等级
...
-- UIModule.SeizeBody.modelDatas[1] = { stand = 0, modelPosition = { -30, 0, -25 }, cameraRotate = { 0, 20, 0 }, scale = 0.2 }

-- jass.udg_MpMaxExtractCount[1] = 100
-- 夺舍
-- code.BeginSeizeBody(1)
-- 血祭需要的杀敌数
jass.udg_HeartKillsCount[1] = 0
-- 天赋挑战次数
jass.udg_TalentChallengeCount[1] = 10
...
-- code.SetUnitAttr_Str(jass.udg_Hero[1], "运气", 100)
-- print(attrSystem:GetObjAttrFromStr(jass.udg_Hero[1], "移动速度"))
-- code.AddUnitAttrStr(jass.udg_Hero[1], "每秒金币+100")
-- code.SetUnitAttr_Str(jass.udg_Hero[1], "攻击加成%", 100)
code.SetUnitAttr_Str(jass.udg_Hero[1], "生命值", 100000)
code.SetUnitAttr_Str(jass.udg_Hero[1], "移动速度", 500)
code.SetUnitAttr_Str(jass.udg_Hero[1], "生命百分比恢复%", 100)
