...
local function open_notice(first)
    ...
    local env = http.env()
    if env == 'release' then
        host = 'create-api.reckfeng.com'
        target = 'https://create.reckfeng.com/wenotice'
    elseif env == 'dev' then
        host = 'dev-create-api-up5.ot.netease.com'
        target = 'https://dev-up5-create.reckfeng.com/wenotice'
    else
        host = 'qa-up5-create-api.reckfeng.com'
        target = 'https://qa-up5-create.reckfeng.com/wenotice'
    end

    local ok, content = http.get(host, 443, '/action/remote/war3Editor/notice')
